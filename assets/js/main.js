/* ===================================================================
    ...
    Template Name   : Pro - Personal Portfolio Template
    Version         : 1.0
    ...
    $(document).on('ready', function() {
		...
		$('#pagepiling').pagepiling({
			...
			navigation: {
				...
				'bulletsColor': '#000',
				'position': 'right',
				'tooltips': ['section1', 'section2', 'section3', 'section4','section5','section6','section7','section8','section9','section10','section11','section12']
			},
